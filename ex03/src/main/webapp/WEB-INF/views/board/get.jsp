	...
	<div class="col-lg-12">
		<div class="panel panel-default">	<!-- /.panel -->
			...
			<div class="panel-body">	<!-- /.panel-body -->
				<ul class="chat">	<!-- /.ul -->
					<li class="left clearfix" data-rno='12'> <!-- start reply -->
						<div>
							<div class="header">
...
//	console.log("remove number : " + count);
...
$(document).ready(function() {
	...
	//모달 수정버튼
	modalMobBtn.on("click", function(e){
	...
	$(".uploadResult").on("click", "li", function(e){
		...
		if(liObj.data("type")){
			...
			//download
			self.location = "/download?fileNmae="+path
		}
	});
